...
public class Dice3D extends Group{
    ...
    public Dice3D() {
        ...
        testMaterial.setDiffuseMap(new Image(getClass().getResourceAsStream("/textures/cube_side.png")));
    ...
    public void roll3DDice() {
        ...
        double rotationSpeed = 2.5 + random.nextDouble() * 2.5; // Randomized speed between 2.5 - 5
