...
public class Coin4Controller extends SceneController{
...
Integer x = moneteChoiceBox.getValue();
    ...
    void initialize() {
    	...
    	List<Cylinder> coins = Arrays.asList(coin1, coin2, coin3, coin4); // oppure una lista già esistente se l’hai da un’altra parte
