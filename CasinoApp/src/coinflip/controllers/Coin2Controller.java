...
import main.Main;
public class Coin2Controller  extends SceneController{
 ...
 //---------------------------------------------------------------------------------------------------
    ...
    private void HandlestartButton() {
        ...
        List<Cylinder> coins = Arrays.asList(coin1, coin2);
...
Integer x = moneteChoiceBox.getValue();
 ...
 public int casi (int a) {
    ...
    void initialize() {
    	...
    	List<Cylinder> coins = Arrays.asList(coin1, coin2); // oppure una lista già esistente se l’hai da un’altra parte
