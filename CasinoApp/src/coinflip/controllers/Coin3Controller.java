...
public class Coin3Controller extends SceneController{
 ...
 // Chat BOT
    ...
    private void HandlestartButton() {
        ...
        List<Cylinder> coins = Arrays.asList(coin1, coin2, coin3);
...
Integer x = moneteChoiceBox.getValue();
 ...
 public int casi (int a) {
    	...
    	switch (molt) {
    	case 0:
    		a = (int) Math.round(a * 0.65);
    		break;
    	case 1:
    		a =  (int) Math.round(a * 0.7);
    ...
    void initialize() {
    	...
    	List<Cylinder> coins = Arrays.asList(coin1, coin2, coin3); // oppure una lista già esistente se l’hai da un’altra parte
